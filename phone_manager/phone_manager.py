...
while True:
  ...
  print ('[' + datetime.datetime.fromtimestamp(time.time()).strftime('%Y-%m-%d %H:%M:%S') + '] Condition: ' + str(result))
  ...
  if result == 1: 
    ...
    print('WARNING: COLLISION DETECTED!')
    print('WARNING: COLLISION DETECTED!')
    print('Emergency Services have been Contacted!')
    ...
    print('Shipping Manager has been Alerted!')
